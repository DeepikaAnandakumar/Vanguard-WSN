...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image1.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image2.png}}
...
\begin{tabular}{|p{0.10\textwidth}|p{0.12\textwidth}|p{0.32\textwidth}|p{0.32\textwidth}|}
\hline
\textbf{Protocol} & \textbf{Topology} & \textbf{Cluster-head / leader selection} & \textbf{Main limitation} \\
\hline
LEACH & Cluster-based & Probabilistic rotation based on threshold $T(n)$ & Ignores residual energy; assumes single-hop CH--BS \\
HEED & Cluster-based & Residual-energy based with iterative refinement & High control overhead due to repeated iterations \\
PEGASIS & Chain-based & Nearest-neighbour chain with rotating leader & Long chain latency; fragile to node failures \\
AI / Swarm-based & Centralized / meta-heuristic & Global optimization using GA/PSO/RL & Requires global state and heavy computation at BS \\
Vanguard-WSN & Tree-based (EBPT) & Deterministic utility index $U_i$ at BS & Requires centralized controller and utility calculation \\
\hline
\end{tabular}
\end{table*}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image4.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image5.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image6.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image7.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image8.png}}
\caption{Throughput Analysis}
\label{fig7}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image9.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{final_final_final_media/image10.png}}
